          ...
          <div class="card-body">
             ...
             <div class="form-group">
              ...
              <div class="form-row">
                  ...
                  <label for="portfolio_id">Select Program</label>
                    <select v-model="program_id" class="form-control">
                  <option v-for="(item,index) in program" :key="index" :value="item.id">{{item.name}}</option>
                </select>
                </div>
                  <div class="form-group col-md-6">
...
import Datepicker from 'vuejs-datepicker'
    ...
    this.$router.push({path:"/admin/page/project"})
     window.toastr['success']('Project Added', 'Success')
    },
